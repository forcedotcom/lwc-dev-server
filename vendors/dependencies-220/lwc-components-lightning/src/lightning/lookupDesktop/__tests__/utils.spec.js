...
import {
    ...
    computeMessageWhenBadInputDefault,
    computeObjectInfo,
...
describe('lookup-desktop:utils', () => {
    ...
    describe('computeMessageWhenBadInputDefault', () => {
        it('Builds label', () => {
            expect(computeMessageWhenBadInputDefault()).toEqual(
                `${i18n.messageWhenBadInputDefault}`
            );
        });
    });
