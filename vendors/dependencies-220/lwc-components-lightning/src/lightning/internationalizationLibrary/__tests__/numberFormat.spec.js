...
describe('When formatting currency', () => {
    ...
    it('should use the currency symbol when "currencyDisplay" is set to "symbol"', () => {
        // Note : "currencyDisplay" default value is symbol and it was tested above
        const options = {
            style: 'currency',
            currency: 'USD',
    ...
    it('should not group when "useGrouping" is set to "false"', () => {
        // useGrouping by default is true
        const options = {
            style: 'currency',
            currency: 'USD',
            useGrouping: false,
...
describe('When formatting plain numbers (decimal style)', () => {
    it('should format when no additional options are provided', () => {
        ...
        // default maximumFractionDigits for style="decimal" on en-US locale is 3
    ...
    it('should format numbers with minimum fraction digits provided', () => {
        ...
        // minimumFractionDigits default is 0 for style="decimal" in en-US locale
...
// Percent formatting is similar to plain numbers, so will only add some basic tests
