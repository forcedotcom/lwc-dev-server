...
describe('columns', () => {
    ...
    describe('normalizeColumns', () => {
        ...
        it('should provide default aria-label for actions', () => {
            const state = {
                columns: [],
                hideCheckboxColumn: true,
            };
            ...
            normalizeColumns(state, [{ type: 'action' }], typesMock);

            const actionsColumn = state.columns[0];

            expect(actionsColumn.ariaLabel).toBe('Actions');
        });
    });
