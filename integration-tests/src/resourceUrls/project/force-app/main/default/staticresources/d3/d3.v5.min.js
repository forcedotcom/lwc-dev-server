...
!(function(t, n) {
    ...
    function Dn(t) {
        ...
        return (
            i === o && o === a
                ? (e = r = u)
                : ((e = On(
                      (0.4360747 * i + 0.3850649 * o + 0.1430804 * a) / En
                  )),
                  (r = On(
                      (0.0139322 * i + 0.0971045 * o + 0.7141733 * a) / Cn
                  ))),
    ...
    function wr(t, n, e, r, i, o) {
        ...
        !(function(t, n, e) {
                    ...
                    if ((h = i[c]).name === e.name) {
                        ...
                        h.state === br
                            ? ((h.state = xr),
                              ...
                              delete i[c])
                            : +c < n &&
                              ((h.state = xr), h.timer.stop(), delete i[c]);
                    }
                if (
                    (hr(function() {
                        e.state === _r &&
            ...
            function u() {
                for (var r in ((e.state = xr), e.timer.stop(), delete i[n], i))
                    return;
    ...
    function Ri(n) {
        ...
        return (
            ...
            (s.prototype = {
                ...
                emit: function(t) {
                    Ct(
                        new di(u, t, n.output(this.state.selection)),
                        o.apply,
                        o,
    ...
    (aa.copy = function() {
        ...
        (aa.visitAfter = function(t) {
            ...
            for (
                this._root &&
                e.push(
                    new ta(this._root, this._x0, this._y0, this._x1, this._y1)
                );
                (n = e.pop());
    ...
    var wa = {
        ...
        s: function(t, n) {
            ...
            var r = e[0],
                ...
                o =
                    i -
                    (ya = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) +
                    1,
                a = r.length;
            return o === a
                ? r
        ...
        function f(t) {
            ...
            function m(t) {
                ...
                switch (
                    (h &&
                        s &&
                        ((t = r(A + t, A.length ? l - x.length : 1 / 0)),
                        (A = '')),
                    e)
                ) {
                    case '<':
    ...
    function ka(t, n) {
        return Math.max(
            0,
            3 * Math.max(-8, Math.min(8, Math.floor(ga(n) / 3))) -
                ga(Math.abs(t))
        );
    }
    function Ca(t, n) {
        ...
        return function(a) {
            var f,
                ...
                x = {
                    ...
                    lineEnd: function() {
                        f &&
                            (M(l, h), d && g && m.rejoin(), f.push(m.result()));
    ...
    function bc() {
        ...
        return (
            ...
            _.extentMajor([[-180, -90 + Da], [180, 90 - Da]]).extentMinor([
                [-180, -80 - Da],
                [180, 80 + Da]
            ])
        );
    ...
    function mh(t, n) {
        ...
        function c() {
            return (
                (e = Math.min(o.length, a.length) > 2 ? _h : yh),
                (r = i = null),
                s
            );
        }
        ...
        jh = Rh(
            ...
            function(t, n) {
                return (
                    (n -
                        t -
                        (n.getTimezoneOffset() - t.getTimezoneOffset()) * Uh) /
                    864e5
                );
            },
            function(t) {
    ...
    function eb(t, n) {
        var e,
            ...
            o = t.sort(nb).pop();
        for (
            J_ = [], Z_ = new Array(t.length), W_ = new M_(), Q_ = new M_();
            ;
    ...
    (ub.prototype = ob.prototype),
        ...
        (t.thresholdScott = function(t, n, e) {
            return Math.ceil(
                (e - n) / (3.5 * c(t) * Math.pow(t.length, -1 / 3))
            );
        }),
            ...
            function l() {
                if (r) {
                    ...
                    for (u = 0, i = new Array(c); u < s; ++u)
                        ((f = t[u]).index = u),
                            'object' != typeof f.source &&
                                (f.source = sa(l, f.source)),
                            'object' != typeof f.target &&
                                (f.target = sa(l, f.target)),
                    ...
                    for (u = 0, o = new Array(s); u < s; ++u)
                        (f = t[u]),
                            (o[u] =
                                i[f.source.index] /
                                (i[f.source.index] + i[f.target.index]));
        ...
        (t.geoCircle = function() {
            ...
            return (
                (a.center = function(t) {
                    return arguments.length
                        ? ((e =
                              'function' == typeof t ? t : Nf([+t[0], +t[1]])),
                          a)
                        : e;
                }),
                (a.radius = function(t) {
        ...
        (t.tree = function() {
            ...
            function i(i) {
                var f = (function(t) {
                    for (
                        var n, e, r, i, o, a = new Gl(t, 0), u = [a];
                        (n = u.pop());
        ...
        (t.pie = function() {
            ...
            function a(a) {
                var u,
                    ...
                    y = Math.min(
                        jg,
                        Math.max(-jg, i.apply(this, arguments) - g)
                    ),
            ...
            function A() {
                if (r.apply(this, arguments)) {
                    ...
                    cb(),
                        ...
                        t.zoom(
                            'mouse',
                            o(b(_(n, e), t.mouse[0], t.mouse[1]), t.extent, c)
                        );
                }
            }
            function T() {
