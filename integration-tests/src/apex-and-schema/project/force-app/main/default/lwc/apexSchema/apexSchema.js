...
import getSingleContact from '@salesforce/apex/ApexTestContactController.getSingleContact';

import NAME_FIELD from '@salesforce/schema/Contact.Name';
import TITLE_FIELD from '@salesforce/schema/Contact.Title';
import EMAIL_FIELD from '@salesforce/schema/Contact.Email';

export default class ApexSchema extends LightningElement {
    ...
    get error() {
        if (this.contact.error) {
            return JSON.stringify(this.contact.error);
        }
        return '';
    }
}
